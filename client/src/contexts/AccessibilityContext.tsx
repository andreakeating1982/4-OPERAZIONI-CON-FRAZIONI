...
/**
 * Barra di accessibilità (stile Cornice Universale, adattata all'app
 * OPERAZIONI CON LE FRAZIONI). Aggiunta per l'inclusione (BES/DSA).
 *
...
const STORAGE_KEY = "wms_access";
const LINE_HEIGHTS = [1.65, 1.9, 2.2, 2.6];
const MIN_SCALE = 0.8;
const MAX_SCALE = 1.6;
