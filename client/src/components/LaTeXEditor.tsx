      ...
      <div className={cn("flex flex-col gap-2", className)}>
        ...
        <div className="flex gap-2">
          <textarea
            ...
            className="flex-1 min-h-[60px] px-3 py-2 rounded-lg bg-background border border-border text-sm font-mono text-foreground resize-y focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary"
            autoFocus
            rows={2}
          />
  ...
  return (
    ...
    >
      <div className="flex items-center gap-2">
        <code className="flex-1 text-xs font-mono text-muted-foreground break-all line-clamp-2 group-hover:text-foreground transition-colors">
          {latex}
        </code>
