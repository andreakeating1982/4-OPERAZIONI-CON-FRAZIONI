#!/usr/bin/env python3
"""
Genera la cornice dinamica AUTOSUFFICIENTE di OPERAZIONI CON LE FRAZIONI:
embed-frazioni.html con i font OpenDyslexic incorporati in base64.
...
OUT = ROOT / "cornice-dinamica" / "embed-frazioni.html"
...
TEMPLATE = """<!-- ============================================================
     OPERAZIONI CON LE FRAZIONI — CORNICE DINAMICA (embed per Blogger)
...
<script>
(function() {
  var iframe = document.getElementById('frIframe');
  if (!iframe) return;
