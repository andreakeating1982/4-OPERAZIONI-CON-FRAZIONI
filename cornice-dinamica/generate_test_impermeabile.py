...
dedicata = (base / "embed-frazioni-dedicata.html").read_text(encoding="utf-8")
...
<div class="post">
  <h2>📄 Post 1 — cornice Operazioni con le Frazioni (istanza A)</h2>
...
<div class="post">
  <h2>📄 Post 2 — cornice Operazioni con le Frazioni (istanza B)</h2>
